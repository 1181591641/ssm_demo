            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/role/userfindAll.do?page=1&size=${pageInfo.pageSize}">首页</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/role/userfindAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/role/userfindAll.do?page=1&size="
            + pageSize;
    }
