...
<script>
    ...
    function checkemail() {
        ...
        if (flag) {
            ...
            //判断是否有重复邮箱
            $.ajax({
                url: "${pageContext.request.contextPath}/user/userEmail.do",
                type: "post",
                data: {"email": username},
                dataType: "json",
    ...
    function checkphoneNum() {
        ...
        //2.定义正则
        var reg_username = /^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$/;
    ...
    $(function () {
        ...
        $("#registerForm").submit(function () {
            //1.发送数据到服务器
            if (checkpassword() && checkemail() && checkphoneNum() && checkusername()) {
